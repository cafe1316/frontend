          ...
          <section className="relative h-[500px]">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-start px-12 md:px-24">
              ...
              <p className="text-lg md:text-xl text-white mb-8 max-w-lg">
                探索我们精心挑选的咖啡豆，感受来自世界各地的独特风味。
              </p>
              <Link
                to="/products"
                className="bg-red-500 text-white px-8 py-3 rounded-full hover:bg-red-600 transition transform hover:scale-105 inline-block"
              >
                立即选购
              </Link>
            </div>
          ...
          <section className="py-16 px-8 md:px-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="flex flex-col space-y-4">
                <img
                  src="https://images.unsplash.com/photo-1520903060300-8c45a14029e9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1440&q=80"
                  alt="咖啡工坊"
                  className="rounded-xl h-64 object-cover"
                />
                <h3 className="text-xl font-bold">咖啡工坊</h3>
                <p className="text-sm">
                  加入我们的线下咖啡工坊，从专业咖啡师那里学习冲泡技巧，探索咖啡的无限可能。
                </p>
                <a href="#" className="text-red-500 flex items-center">
              ...
              <div className="flex flex-col space-y-4">
                <img
                  src="https://images.unsplash.com/photo-1450353301998-196516b4a8ae?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1440&q=80"
                  alt="咖啡知识"
                  className="rounded-xl h-64 object-cover"
                />
                <h3 className="text-xl font-bold">咖啡科普</h3>
                <p className="text-sm">
                  通过我们的咖啡百科，了解咖啡从种植到杯中的全过程，成为一个真正的咖啡达人。
                </p>
                <a href="#" className="text-red-500 flex items-center">
                  了解更多 <i className="fas fa-arrow-right ml-2"></i>
                </a>
            ...
            <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                <input
                  type="email"
                  placeholder="您的邮箱地址"
                  className="px-6 py-3 flex-1 rounded-full border focus:outline-none focus:ring-2 focus:ring-red-500"
                />
