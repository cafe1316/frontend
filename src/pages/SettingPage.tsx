                                ...
                                <div className="p-6">
                                    <form>
                                        ...
                                        <div className="flex flex-col md:flex-row items-start md:items-center mb-6">
                                            ...
                                            <div className="flex-1">
                                                <input type="text" defaultValue="Ming Zhang"
                                        ...
                                        <div className="flex flex-col md:flex-row items-start md:items-center mb-6">
                                            ...
                                            <div className="flex-1">
                                                <input type="text" defaultValue="Coffee Lover"
                                                    className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent" />
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-col md:flex-row items-start md:items-center mb-6">
                                            ...
                                            <div className="flex-1">
                                                <input type="tel" defaultValue="138****1234" disabled
                                        ...
                                        <div className="flex flex-col md:flex-row items-start md:items-center mb-6">
                                            ...
                                            <div className="flex-1">
                                                <input type="email" defaultValue="zhangming@example.com"
                                                    className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent" />
                                            </div>
                                        </div>
