                ...
                <div className="mx-auto max-w-[1440px] h-[1024px] bg-white shadow-lg flex flex-col overflow-hidden">
                    <main className="flex-1 flex flex-col md:flex-row">
                        ...
                        <aside className="w-64 bg-gray-50 p-6 border-r hidden md:block">
                            ...
                            <div className="mb-8">
                                <h3 className="font-medium mb-3 text-sm uppercase text-gray-500">Coffee Beans</h3>
                            ...
                            <div className="mb-8">
                                <h3 className="font-medium mb-3 text-sm uppercase text-gray-500">Brewing Gear</h3>
                                <ul className="space-y-2 text-sm">
                                    <li>
                                        <a href="#" className="flex items-center justify-between hover:text-red-500 transition">
                                            <span>All Gear</span>
                            ...
                            <div className="mb-8">
                                <h3 className="font-medium mb-3 text-sm uppercase text-gray-500">Accessories</h3>
                                <ul className="space-y-2 text-sm">
                                    <li>
                                        <a href="#" className="flex items-center justify-between hover:text-red-500 transition">
                            ...
                            <div className="p-6 border-b bg-white">
                                <div className="flex flex-col md:flex-row md:items-center md:space-x-4 space-y-4 md:space-y-0 mb-6">
                                    <div className="relative flex-1">
                                        <input type="text" placeholder="Search coffee beans, gear or accessories..." className="w-full py-2 pl-10 pr-4 border rounded-full focus:outline-none focus:ring-2 focus:ring-red-500" />
                            ...
                            <div className="p-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
                                ...
                                <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition p-4 card-hover">
                                    ...
                                    <div className="mb-2 flex items-center">
                                        <span className="bg-gray-100 text-xs px-2 py-1 rounded mr-2">Light</span>
                                        <span className="text-xs text-gray-500">Ethiopia</span>
                                    </div>
                                    <h3 className="font-bold mb-1 leading-tight">Ethiopia Yirgacheffe</h3>
                                    <p className="text-sm text-gray-600 mb-2">Floral, fruity, clean finish</p>
                                ...
                                <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition p-4 card-hover">
                                    ...
                                    <div className="mb-2 flex items-center">
                                        <span className="bg-gray-100 text-xs px-2 py-1 rounded mr-2">Medium</span>
                                        <span className="text-xs text-gray-500">Colombia</span>
                                    </div>
                                    <h3 className="font-bold mb-1 leading-tight">Colombia Caldas</h3>
                                    <p className="text-sm text-gray-600 mb-2">Balanced, caramel sweetness</p>
                                    <div className="flex justify-between items-center">
                                ...
                                <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition p-4 card-hover">
                                    ...
                                    <div className="mb-2 flex items-center">
                                        <span className="bg-gray-100 text-xs px-2 py-1 rounded mr-2">Dark</span>
                                        <span className="text-xs text-gray-500">Brazil</span>
                                    </div>
                                    <h3 className="font-bold mb-1 leading-tight">Brazil Daterra Estate</h3>
                                    <p className="text-sm text-gray-600 mb-2">Chocolatey, low acidity</p>
                                    <div className="flex justify-between items-center">
                                        <div>
                                ...
                                <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition p-4 card-hover">
                                    ...
                                    <p className="text-sm text-gray-600 mb-2">Citrus acidity, mild floral</p>
                                    <div className="flex justify-between items-center">
                                ...
                                <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition p-4 card-hover">
                                    ...
                                    <div className="mb-2 flex items-center">
                                        <span className="bg-gray-100 text-xs px-2 py-1 rounded mr-2">Gear</span>
                                        <span className="text-xs text-gray-500">Pour-over Set</span>
                                    </div>
                                    <h3 className="font-bold mb-1 leading-tight">Exquisite Pour-over Set</h3>
                                ...
                                <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition p-4 card-hover">
                                    ...
                                    <h3 className="font-bold mb-1 leading-tight">Wooden Manual Grinder</h3>
                                    <p className="text-sm text-gray-600 mb-2">Even grind, retro design</p>
                                    <div className="flex justify-between items-center">
                                ...
                                <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition p-4 card-hover">
                                    ...
                                    <p className="text-sm text-gray-600 mb-2">Portable cold brew maker</p>
                                    <div className="flex justify-between items-center">
                                ...
                                <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition p-4 card-hover">
                                    ...
                                    <div className="mb-2 flex items-center">
                                        <span className="bg-gray-100 text-xs px-2 py-1 rounded mr-2">Accessory</span>
                                        <span className="text-xs text-gray-500">Cups</span>
                                    </div>
                                    <h3 className="font-bold mb-1 leading-tight">Nordic Ceramic Cup Set</h3>
                                    <p className="text-sm text-gray-600 mb-2">Minimalist design, set of 4</p>
                                    <div className="flex justify-between items-center">
                                ...
                                <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition p-4 card-hover">
                                    ...
                                    <p className="text-sm text-gray-600 mb-2">Bright acidity, berry notes</p>
                                    <div className="flex justify-between items-center">
                                ...
                                <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition p-4 card-hover">
                                    ...
                                    <h3 className="font-bold mb-1 leading-tight">Global Tasting Gift Box</h3>
                                    <p className="text-sm text-gray-600 mb-2">Selected beans from 4 regions</p>
                                    <div className="flex justify-between items-center">
                                ...
                                <div className="bg-white rounded-xl shadow-sm hover:shadow-md transition p-4 card-hover">
                                    ...
                                    <p className="text-sm text-gray-600 mb-2">Lemon aroma, bright acidity</p>
                                    <div className="flex justify-between items-center">
                                        <span className="font-bold">¥138</span>
                                        <button className="bg-red-500 text-white p-2 rounded-full hover:bg-red-600 transition">
                                            <i className="fas fa-plus"></i>
